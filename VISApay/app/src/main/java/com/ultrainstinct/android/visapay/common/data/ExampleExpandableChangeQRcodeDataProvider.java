...
public class ExampleExpandableChangeQRcodeDataProvider extends AbstractExpandableDataProvider {
    ...
    public static ArrayList<QRcode> changeQRcodeContents = new ArrayList<QRcode>();


    public ExampleExpandableChangeQRcodeDataProvider(){

        mData = new LinkedList<>();

        Log.e("TEST", "ExampleExpandableChangeQRcodeDataProvider: " + groupItems);
        ...
        for (int i = 0, j = 0; i < groupItems.length();i++) {
            ...
            final ExampleExpandableChangeQRcodeDataProvider.ConcreteGroupData group = new ExampleExpandableChangeQRcodeDataProvider.ConcreteGroupData(groupId, groupText);
            ...
            for(int k = 0; k < 3; k++){
                ...
                children.add(new ExampleExpandableChangeQRcodeDataProvider.ConcreteChildData(childId, s));
            }
    ...
    public void moveChildItem(int fromGroupPosition, int fromChildPosition, int toGroupPosition, int toChildPosition) {
        ...
        final ExampleExpandableChangeQRcodeDataProvider.ConcreteChildData item = (ExampleExpandableChangeQRcodeDataProvider.ConcreteChildData) fromGroup.second.remove(fromChildPosition);

        if (toGroupPosition != fromGroupPosition) {
            // assign a new ID
            final long newId = ((ExampleExpandableChangeQRcodeDataProvider.ConcreteGroupData) toGroup.first).generateNewChildId();
