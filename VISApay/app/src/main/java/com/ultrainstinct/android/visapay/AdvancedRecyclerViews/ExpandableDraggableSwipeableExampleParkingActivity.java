...
public class ExpandableDraggableSwipeableExampleParkingActivity extends AppCompatActivity implements ExpandableItemPinnedMessageDialogFragment.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(new ExampleExpandableParkingDataProviderFragment(), FRAGMENT_TAG_DATA_PROVIDER)
                    .commit();
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, new ExpandableDraggableSwipeableExampleParkingFragment(), FRAGMENT_LIST_VIEW)
                    .commit();
        }
    }
    ...
    public void onGroupItemClicked(int groupPosition) {
        ...
        if (data.isPinned()) {
            ...
            ((ExpandableDraggableSwipeableExampleParkingFragment) fragment).notifyGroupItemChanged(groupPosition);
        }
    }
    ...
    public void onChildItemClicked(int groupPosition, int childPosition) {
        ...
        if (data.isPinned()) {
            // unpin if tapped the pinned item
            data.setPinned(false);
            ((ExpandableDraggableSwipeableExampleParkingFragment) fragment).notifyChildItemChanged(groupPosition, childPosition);
        }
    }
    ...
    private void onItemUndoActionClicked() {
        ...
        if (childPosition == RecyclerView.NO_POSITION) {
            ...
            // child item
            ((ExpandableDraggableSwipeableExampleParkingFragment) fragment).notifyChildItemRestored(groupPosition, childPosition);
        }
    }
    ...
    public AbstractExpandableDataProvider getDataProvider() {
        ...
        return ((ExampleExpandableParkingDataProviderFragment) fragment).getDataProvider();
    }
