...
public class ExampleExpandableSalesDataProvider extends AbstractExpandableDataProvider {
    ...
    public static ArrayList<Sale> salesContents = new ArrayList<Sale>();


    public ExampleExpandableSalesDataProvider(){

        mData = new LinkedList<>();

        Log.e("TEST", "ExampleExpandableSalesDataProvider: " + groupItems);
        ...
        for (int i = 0, j = 0; i < groupItems.length();i++) {
            ...
            final ExampleExpandableSalesDataProvider.ConcreteGroupData group = new ExampleExpandableSalesDataProvider.ConcreteGroupData(groupId, groupText);
            ...
            for(int k = 0; k < 3; k++){
                ...
                children.add(new ExampleExpandableSalesDataProvider.ConcreteChildData(childId, s));
            }
    ...
    public void moveChildItem(int fromGroupPosition, int fromChildPosition, int toGroupPosition, int toChildPosition) {
        ...
        final ExampleExpandableSalesDataProvider.ConcreteChildData item = (ExampleExpandableSalesDataProvider.ConcreteChildData) fromGroup.second.remove(fromChildPosition);

        if (toGroupPosition != fromGroupPosition) {
            // assign a new ID
            final long newId = ((ExampleExpandableSalesDataProvider.ConcreteGroupData) toGroup.first).generateNewChildId();
