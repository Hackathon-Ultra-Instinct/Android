...
import com.ultrainstinct.android.visapay.QRCodeActivity;
...
public class UploadScanChangeBarcodeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @Override
        ...
        private void setUpWorkflowModel() {
            ...
            workflowModel.detectedBarcode.observe(
                    this,
                    new Observer<FirebaseVisionBarcode>() {
                        @Override
                        public void onChanged(FirebaseVisionBarcode barcode) {
                            if (barcode != null) {
                                ...
                                BarcodeResultFragment.show(UploadScanChangeBarcodeActivity.this.getSupportFragmentManager(), barcodeFieldList);
                            }
                        }
                    });
        }
