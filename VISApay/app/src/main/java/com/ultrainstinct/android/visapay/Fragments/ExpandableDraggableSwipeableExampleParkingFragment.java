...
public class ExpandableDraggableSwipeableExampleParkingFragment extends Fragment
    ...
    public ExpandableDraggableSwipeableExampleParkingFragment() {
        super();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myItemAdapter.setEventListener(new ExpandableDraggableSwipeableExampleAdapter.EventListener() {
            ...
            public void onGroupItemRemoved(int groupPosition) {
                ((ExpandableDraggableSwipeableExampleParkingActivity) getActivity()).onGroupItemRemoved(groupPosition);
            }

            @Override
            public void onChildItemRemoved(int groupPosition, int childPosition) {
                ((ExpandableDraggableSwipeableExampleParkingActivity) getActivity()).onChildItemRemoved(groupPosition, childPosition);
            }

            @Override
            public void onGroupItemPinned(int groupPosition) {
                ((ExpandableDraggableSwipeableExampleParkingActivity) getActivity()).onGroupItemPinned(groupPosition);
            }

            @Override
            public void onChildItemPinned(int groupPosition, int childPosition) {
                ((ExpandableDraggableSwipeableExampleParkingActivity) getActivity()).onChildItemPinned(groupPosition, childPosition);
            }
    ...
    private void onItemViewClick(View v, boolean pinned) {
        ...
        if (childPosition == RecyclerView.NO_POSITION) {
            ((ExpandableDraggableSwipeableExampleParkingActivity) getActivity()).onGroupItemClicked(groupPosition);
        } else {
            ((ExpandableDraggableSwipeableExampleParkingActivity) getActivity()).onChildItemClicked(groupPosition, childPosition);
        }
    }
    ...
    public AbstractExpandableDataProvider getDataProvider() {
        return ((ExpandableDraggableSwipeableExampleParkingActivity) getActivity()).getDataProvider();
    }
