...
public class ExpandableDraggableSwipeableExampleChangeBarcodeFragment extends Fragment
    ...
    public ExpandableDraggableSwipeableExampleChangeBarcodeFragment() {
        super();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myItemAdapter.setEventListener(new ExpandableDraggableSwipeableExampleAdapter.EventListener() {
            ...
            public void onGroupItemRemoved(int groupPosition) {
                ((ExpandableDraggableSwipeableExampleChangeBarcodeActivity) getActivity()).onGroupItemRemoved(groupPosition);
            }

            @Override
            public void onChildItemRemoved(int groupPosition, int childPosition) {
                ((ExpandableDraggableSwipeableExampleChangeBarcodeActivity) getActivity()).onChildItemRemoved(groupPosition, childPosition);
            }

            @Override
            public void onGroupItemPinned(int groupPosition) {
                ((ExpandableDraggableSwipeableExampleChangeBarcodeActivity) getActivity()).onGroupItemPinned(groupPosition);
            }

            @Override
            public void onChildItemPinned(int groupPosition, int childPosition) {
                ((ExpandableDraggableSwipeableExampleChangeBarcodeActivity) getActivity()).onChildItemPinned(groupPosition, childPosition);
            }
    ...
    private void onItemViewClick(View v, boolean pinned) {
        ...
        if (childPosition == RecyclerView.NO_POSITION) {
            ((ExpandableDraggableSwipeableExampleChangeBarcodeActivity) getActivity()).onGroupItemClicked(groupPosition);
        } else {
            ((ExpandableDraggableSwipeableExampleChangeBarcodeActivity) getActivity()).onChildItemClicked(groupPosition, childPosition);
        }
    }
    ...
    public AbstractExpandableDataProvider getDataProvider() {
        return ((ExpandableDraggableSwipeableExampleChangeBarcodeActivity) getActivity()).getDataProvider();
    }
