...
public class ExpandableDraggableSwipeableExampleChangeQRcodeFragment extends Fragment
    ...
    public ExpandableDraggableSwipeableExampleChangeQRcodeFragment() {
        super();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        myItemAdapter.setEventListener(new ExpandableDraggableSwipeableExampleAdapter.EventListener() {
            ...
            public void onGroupItemRemoved(int groupPosition) {
                ((ExpandableDraggableSwipeableExampleChangeQRcodeActivity) getActivity()).onGroupItemRemoved(groupPosition);
            }

            @Override
            public void onChildItemRemoved(int groupPosition, int childPosition) {
                ((ExpandableDraggableSwipeableExampleChangeQRcodeActivity) getActivity()).onChildItemRemoved(groupPosition, childPosition);
            }

            @Override
            public void onGroupItemPinned(int groupPosition) {
                ((ExpandableDraggableSwipeableExampleChangeQRcodeActivity) getActivity()).onGroupItemPinned(groupPosition);
            }

            @Override
            public void onChildItemPinned(int groupPosition, int childPosition) {
                ((ExpandableDraggableSwipeableExampleChangeQRcodeActivity) getActivity()).onChildItemPinned(groupPosition, childPosition);
            }
    ...
    private void onItemViewClick(View v, boolean pinned) {
        ...
        if (childPosition == RecyclerView.NO_POSITION) {
            ((ExpandableDraggableSwipeableExampleChangeQRcodeActivity) getActivity()).onGroupItemClicked(groupPosition);
        } else {
            ((ExpandableDraggableSwipeableExampleChangeQRcodeActivity) getActivity()).onChildItemClicked(groupPosition, childPosition);
        }
    }
    ...
    public AbstractExpandableDataProvider getDataProvider() {
        return ((ExpandableDraggableSwipeableExampleChangeQRcodeActivity) getActivity()).getDataProvider();
    }
